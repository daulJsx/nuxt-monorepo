...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/pq2ihWWQK7)
...
```sh
npx nx serve nuxt-app
```

To create a production bundle:

```sh
npx nx build nuxt-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project nuxt-app
```
